...
export default function DefictCalculator() {
    ...
    return (
        <div className="p-5 deficitCalculator">
            ...
            <input type="number" min="0" max="120" value={age} onChange={(e) => setAge(e.target.value)}></input><br></br>
            <label className="m-1 mt-4">Height(cm): </label>
            <input type="number" min="0" max="300" value={height} onChange={(e) => setHeight(e.target.value)}></input><br></br>
            <label className="m-1 mt-4 mb-4">Weight(50-150kg): </label>
            <input type="range" min="50" max="150" value={weight} onChange={(e) => setWeight(e.target.value)}></input><br></br>
